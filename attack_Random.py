...
for n_perturbations in [0,100,500,1000]:
    model = Random()
    model.attack(adj, n_perturbations, type='remove')
    ...
    train(graph, model,result_path='results/Randomattack'+str(n_perturbations)+'remove.txt')
